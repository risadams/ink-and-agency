...
### [**ansible-expert**](ansible-expert.md) - Ansible infrastructure automation specialist

Master of infrastructure-as-code specializing in large-scale automation, configuration management, and cloud orchestration. Expert in playbooks, roles, Jinja2 templating, and multi-environment deployment strategies. Builds reliable, idempotent infrastructure automation with comprehensive testing.

**Use when:** Building infrastructure automation, managing system configuration at scale, orchestrating cloud resources, implementing zero-downtime deployments, or creating reusable infrastructure roles.
...
### [**gradle-expert**](gradle-expert.md) - Gradle build automation specialist

Build infrastructure expert specializing in Gradle 7+/8+ and JVM project automation. Mastering multi-module architecture, dependency management, plugin development, and performance optimization. Builds scalable, maintainable build systems for enterprise projects.

**Use when:** Configuring Gradle projects, optimizing build performance, implementing multi-module architectures, managing complex dependencies, or developing custom Gradle plugins.
...
### [**shell-expert**](shell-expert.md) - Shell scripting specialist

Master of system automation and scripting with expertise in POSIX sh, Bash, and Zsh. Specializes in cross-platform portability, robust error handling, and production-grade automation scripts. Builds reliable infrastructure tooling and deployment automation.

**Use when:** Writing system administration scripts, building deployment automation, creating DevOps tooling, implementing cross-platform shell scripts, or optimizing bash/zsh performance.
...
|-------------------|----------|----------|
| Ansible | **ansible-expert** | Infrastructure automation, configuration management |
...
| Gradle | **gradle-expert** | JVM build automation, multi-module projects |
...
| Shell (sh/bash/zsh) | **shell-expert** | System automation, DevOps scripts |
