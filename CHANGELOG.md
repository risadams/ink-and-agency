...
### Added
- Add six skills, extract shared references, harden the workflow set
- Add plugin logo and brand color for host UIs
- Introduce core vocabulary skills and add new workflow utilities
- Conform to the Agent Plugins 1.0.0 open standard

## [1.6.0] - 2026-08-03

### Changed
- Contined optomizations
- Claude 5 optimizations

### Fixed
- Replace truncated Codex picker labels
- Resolve persona and portability links

## [1.5.2] - 2026-07-28

### Added
- Add core README structure and review guidelines
- Add neurodivergent-friendly executive function skills

### Changed
- Synchronize skill descriptions and README with new capabilities
- Update skill instructions and workflow

## [1.5.1] - 2026-07-27

### Added
- Add prototype skill and wire it into both hosts

## [1.5.0] - 2026-07-16

### Added
- Add self-evolve loop to every skill

### Changed
- Explain how self-evolution works
