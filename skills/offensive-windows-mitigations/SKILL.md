...
codex-short-description: "Deep-dive on Windows exploit mitigations: ASLR, DEP/NX, CFG, CET/Shadow Stack, SEHOP,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-windows-mitigations.md` (workspace-local
`.ink-and-agency/learnings/offensive-windows-mitigations.md` where the sandbox confines writes). Read it
