...
- **[grill-me](../grill-me/)** (`/grilling`) and `/domain-modeling` — to name the destination and resolve grilling-type tickets, one question at a time.
- **[research](../research/)** (`/research`) — background subagents that resolve research tickets in parallel.
