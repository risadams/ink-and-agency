...
journal — `~/.ink-and-agency/learnings/mobile-developer.md` and/or the workspace-local
`.ink-and-agency/learnings/mobile-developer.md` — if present, and apply its guidance.
