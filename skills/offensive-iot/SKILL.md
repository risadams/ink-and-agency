...
Journal: `~/.ink-and-agency/learnings/offensive-iot.md` (workspace-local
`.ink-and-agency/learnings/offensive-iot.md` where the sandbox confines writes). Read it
