...
Journal: `~/.ink-and-agency/learnings/offensive-advanced-redteam.md` (workspace-local
`.ink-and-agency/learnings/offensive-advanced-redteam.md` where the sandbox confines writes). Read it
