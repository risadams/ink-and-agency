...
codex-short-description: "EDR evasion offensive checklist: hook unhooking (user/kernel), direct syscalls, PPID…"
...
Journal: `~/.ink-and-agency/learnings/offensive-edr-evasion.md` (workspace-local
`.ink-and-agency/learnings/offensive-edr-evasion.md` where the sandbox confines writes). Read it
