...
Journal: `~/.ink-and-agency/learnings/offensive-anti-forensics.md` (workspace-local
`.ink-and-agency/learnings/offensive-anti-forensics.md` where the sandbox confines writes). Read it
