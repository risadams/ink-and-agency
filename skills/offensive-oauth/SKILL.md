...
codex-short-description: "OAuth 2.0 attack checklist: authorization code interception, redirect_uri bypass, CSRF…"
...
Journal: `~/.ink-and-agency/learnings/offensive-oauth.md` (workspace-local
`.ink-and-agency/learnings/offensive-oauth.md` where the sandbox confines writes). Read it
