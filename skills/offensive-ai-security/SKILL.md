...
codex-short-description: "AI/LLM security offensive checklist: prompt injection, jailbreaking, model extraction,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-ai-security.md` (workspace-local
`.ink-and-agency/learnings/offensive-ai-security.md` where the sandbox confines writes). Read it
