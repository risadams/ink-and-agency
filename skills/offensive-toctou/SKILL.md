...
codex-short-description: "Time-of-Check / Time-of-Use (TOCTOU) race condition exploitation methodology across…"
...
Journal: `~/.ink-and-agency/learnings/offensive-toctou.md` (workspace-local
`.ink-and-agency/learnings/offensive-toctou.md` where the sandbox confines writes). Read it
