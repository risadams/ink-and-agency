...
- **Pair with the project's CONTEXT.md.** If the project has a domain glossary, the map will use those terms. If not, the map describes shapes generically — consider adding a CONTEXT.md afterward (use [grill-with-docs](../../research-analysis/grill-with-docs/) to draft one).
...
- ❌ **Propose refactors.** The output is descriptive, not prescriptive. For refactor suggestions, use [codebase-improve-architecture](../../codebase-build/codebase-improve-architecture/).
...
- ❌ **Find bugs.** Mapping is orientation; bug-finding is investigation. For triage, use [issue-triage](../../business-product/issue-triage/).
...
A: Yes — the map will use generic descriptions. If you find yourself wanting domain vocabulary, that's a signal to draft a CONTEXT.md (see [grill-with-docs](../../research-analysis/grill-with-docs/)).
...
- **[codebase-improve-architecture](../../codebase-build/codebase-improve-architecture/)** — once you have a map, this skill helps you decide what to deepen or refactor.
- **[issue-triage](../../business-product/issue-triage/)** — Phase 2 invokes `/codebase-explain` automatically when triaging a Jira bug.
- **[grill-with-docs](../../research-analysis/grill-with-docs/)** — when the project has no CONTEXT.md, use this to draft one. The map quality improves dramatically once domain vocabulary is captured.
