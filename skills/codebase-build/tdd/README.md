...
- **[implement](../../codebase-build/implement/)** — drives this skill as its test-first phase (and can skip it for prototypes).
- **[debug](../../codebase-build/debug/)** — for hard bugs, builds a failing repro loop first; TDD is for building *features* test-first.
- **[code-review](../../codebase-build/code-review/)** — the stage where refactoring happens, after the red→green loop is green.
