...
- **[tdd](../../codebase-build/tdd/)** — the red→green loop (when test-first is on).
- **[code-review](../../codebase-build/code-review/)** — two-axis review (when review is on).
...
- **[tdd](../../codebase-build/tdd/)** — the test-first phase; the red→green loop and what makes a test worth keeping.
- **[code-review](../../codebase-build/code-review/)** — the review phase; two-axis (Standards + Spec) review of the working diff.
- **[plan-to-tickets](../../meta-orchestration/plan-to-tickets/)** — produces the tickets this skill consumes, one per fresh context.
