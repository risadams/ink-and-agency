...
- **[codebase-improve-architecture](../../codebase-build/codebase-improve-architecture/)** — handed the specifics when the root cause is architectural.
...
- **[codebase-improve-architecture](../../codebase-build/codebase-improve-architecture/)** — the Phase 6 hand-off when a bug's root cause is architectural (no test seam, tangled callers, hidden coupling).
- **[codebase-explain](../../codebase-build/codebase-explain/)** — build a mental model of an unfamiliar module before diving into a bug in it.
- **[issue-triage](../../business-product/issue-triage/)** — for the earlier step of ranking *candidate* root causes from a ticket, before you commit to reproducing one.
