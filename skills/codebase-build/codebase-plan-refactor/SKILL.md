...
journal — `~/.ink-and-agency/learnings/codebase-plan-refactor.md` and/or the workspace-local
`.ink-and-agency/learnings/codebase-plan-refactor.md` — if present, and apply its guidance.
