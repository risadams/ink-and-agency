...
- **[codebase-improve-architecture](../../codebase-build/codebase-improve-architecture/)** — once churn surfaces a hot file, this skill helps decide *what* to refactor it into. The two pair naturally.
- **[codebase-explain](../../codebase-build/codebase-explain/)** — when a hot file is unfamiliar, get a high-level map first before diving in.
