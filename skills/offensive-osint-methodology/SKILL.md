...
description: "Structured OSINT methodology framework: target definition, source selection, collection workflows, data correlation, timeline reconstruction, and reporting. Use to guide systematic OSINT campaigns or teach OSINT methodology. Use when performing authorized red-team, pentest, or research work involving osint methodology."
codex-short-description: "Structured OSINT methodology framework: target definition, source selection,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-osint-methodology.md` (workspace-local
`.ink-and-agency/learnings/offensive-osint-methodology.md` where the sandbox confines writes). Read it
