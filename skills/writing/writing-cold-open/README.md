...
- ❌ **Writing past the first sentence.** That's not what this skill is for — route to [writing-social-script](../../writing/writing-social-script/) or [writing-tone-check](../../writing/writing-tone-check/) if you need a whole draft reviewed or generated.
...
- **[task-initiation](../../exec-function/task-initiation/)** — sibling for non-writing stalls. Same shape of output (one literal action / one literal sentence, then exit).
