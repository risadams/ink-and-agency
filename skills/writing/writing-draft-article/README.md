...
- Pile of raw thoughts, no structure → [writing-fragments](../../writing/writing-fragments/)
- Has notes/fragments, wants paragraph-by-paragraph → [writing-shape](../../writing/writing-shape/)
- Wants narrative/journey structure → [writing-beats](../../writing/writing-beats/)
- Draft sounds AI-generated → [writing-humanize](../../writing/writing-humanize/)
- Wants stress-test on plan/thesis → [grill-me](../../research-analysis/grill-me/)
...
- **[writing-fragments](../../writing/writing-fragments/)** — for the upstream work when you don't have material yet.
- **[writing-shape](../../writing/writing-shape/)** — paragraph-by-paragraph shaping with format arguments. Delegated to from Phase 3 when material is plentiful and structure is the question.
- **[writing-beats](../../writing/writing-beats/)** — narrative shaping for choose-your-own-adventure articles.
- **[writing-humanize](../../writing/writing-humanize/)** — Phase 4 delegates to this when AI patterns are detected.
- **[grill-me](../../research-analysis/grill-me/)** — Phase 1 can delegate here for deeper thesis stress-testing.
