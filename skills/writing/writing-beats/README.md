...
- ❌ **Outline the whole article up front.** That's the technique this skill exists to avoid. If you want an outline, use [writing-shape](../../writing/writing-shape/) instead.
...
A: Better for medium-length essays. For social posts and threads, [writing-shape](../../writing/writing-shape/) tends to work better because beats want room to pivot.

## Related skills

- **[writing-fragments](../../writing/writing-fragments/)** — generates the raw material pile this skill consumes.
- **[writing-shape](../../writing/writing-shape/)** — alternative shaping mode: paragraph-by-paragraph with format arguments at each step.
- **[writing-draft-article](../../writing/writing-draft-article/)** — top-level skill that delegates to beats when narrative shape is what you want.
