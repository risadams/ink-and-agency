...
A pre-send tone reviewer. Paste a draft message, name the recipient and the goal, and get back a landing prediction (cold / passive-aggressive / over-apologetic / warm) plus targeted rewrite suggestions. The sibling to [break-it-down](../../exec-function/break-it-down/) — that one decodes incoming, this one previews outgoing.
...
- **[break-it-down](../../exec-function/break-it-down/)** — the inverse: decoding incoming messages.
