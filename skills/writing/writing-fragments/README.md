...
- **[writing-shape](../../writing/writing-shape/)** — the natural next step. Once you have a fragment pile, shape mines it paragraph by paragraph.
- **[writing-beats](../../writing/writing-beats/)** — alternative next step. Beats mines the pile as a sequence of journey moves.
- **[writing-draft-article](../../writing/writing-draft-article/)** — top-level skill that delegates here when the user lacks raw material.
