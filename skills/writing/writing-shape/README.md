...
A: The skill names gaps as it goes. If the gaps overwhelm the material, the skill suggests stopping and using [writing-fragments](../../writing/writing-fragments/) to mine more before continuing.
...
- **[writing-fragments](../../writing/writing-fragments/)** — for the upstream work when the pile doesn't exist yet.
- **[writing-beats](../../writing/writing-beats/)** — alternative shaping mode: choose-your-own-adventure journey instead of paragraph-by-paragraph.
- **[writing-draft-article](../../writing/writing-draft-article/)** — top-level skill that delegates here when material is plentiful and structure is the question.
- **[writing-humanize](../../writing/writing-humanize/)** — run after shaping if the prose has drifted into AI patterns.
