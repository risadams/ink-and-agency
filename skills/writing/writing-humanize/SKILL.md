...
The full 29-pattern detection catalog — content, language, style, communication, and filler/hedging patterns, each with before/after examples — lives in [references/patterns.md](references/patterns.md). Work through every category there when auditing.

## Process

1. Read the input text carefully
2. Identify all instances of the patterns in [references/patterns.md](references/patterns.md)
...
- Removed em dashes, emojis, boldface headers, and curly/smart quotes
