...
Journal: `~/.ink-and-agency/learnings/offensive-linux-privesc.md` (workspace-local
`.ink-and-agency/learnings/offensive-linux-privesc.md` where the sandbox confines writes). Read it
