...
Journal: `~/.ink-and-agency/learnings/windows-infra-admin.md` (workspace-local
`.ink-and-agency/learnings/windows-infra-admin.md` where the sandbox confines writes). Read it
