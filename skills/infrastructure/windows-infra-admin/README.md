...
- [terraform-engineer](../../infrastructure/terraform-engineer/)
...
Model-invoked from the `description` triggers above, or run by name (`windows-infra-admin`). Compatible with: claude-code codex opencode.
