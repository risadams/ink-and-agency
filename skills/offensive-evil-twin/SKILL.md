...
Journal: `~/.ink-and-agency/learnings/offensive-evil-twin.md` (workspace-local
`.ink-and-agency/learnings/offensive-evil-twin.md` where the sandbox confines writes). Read it
