...
codex-short-description: "Dense description covering ARP spoofing, LLMNR/NBT-NS/mDNS poisoning, DNS poisoning,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-network-attacks.md` (workspace-local
`.ink-and-agency/learnings/offensive-network-attacks.md` where the sandbox confines writes). Read it
