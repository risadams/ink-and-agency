...
codex-short-description: "Z-Wave attack methodology — sniffing with Z-Force / EZ-Wave / RTL-SDR + ZniffMobile,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-z-wave.md` (workspace-local
`.ink-and-agency/learnings/offensive-z-wave.md` where the sandbox confines writes). Read it
