...
codex-short-description: "Comprehensive offensive methodology for software supply chain attacks covering the…"
...
Journal: `~/.ink-and-agency/learnings/offensive-supply-chain.md` (workspace-local
`.ink-and-agency/learnings/offensive-supply-chain.md` where the sandbox confines writes). Read it
