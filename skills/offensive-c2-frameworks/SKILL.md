...
Journal: `~/.ink-and-agency/learnings/offensive-c2-frameworks.md` (workspace-local
`.ink-and-agency/learnings/offensive-c2-frameworks.md` where the sandbox confines writes). Read it
