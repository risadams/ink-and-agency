...
codex-short-description: "WPA/WPA2-PSK attack methodology — four-way handshake capture via targeted…"
...
Journal: `~/.ink-and-agency/learnings/offensive-wpa2-psk.md` (workspace-local
`.ink-and-agency/learnings/offensive-wpa2-psk.md` where the sandbox confines writes). Read it
