...
codex-short-description: "XML External Entity injection testing checklist: classic XXE, blind XXE (out-of-band),…"
...
Journal: `~/.ink-and-agency/learnings/offensive-xxe.md` (workspace-local
`.ink-and-agency/learnings/offensive-xxe.md` where the sandbox confines writes). Read it
