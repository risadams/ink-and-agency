...
codex-short-description: "Comprehensive API security testing methodology covering REST, gRPC, and WebSocket…"
...
Journal: `~/.ink-and-agency/learnings/offensive-api-security.md` (workspace-local
`.ink-and-agency/learnings/offensive-api-security.md` where the sandbox confines writes). Read it
