...
codex-short-description: "WPA/WPA2/WPA3-Enterprise (802.1X / EAP) attack methodology — EAP method identification…"
...
Journal: `~/.ink-and-agency/learnings/offensive-wpa-enterprise.md` (workspace-local
`.ink-and-agency/learnings/offensive-wpa-enterprise.md` where the sandbox confines writes). Read it
