...
Journal: `~/.ink-and-agency/learnings/offensive-api-abuse.md` (workspace-local
`.ink-and-agency/learnings/offensive-api-abuse.md` where the sandbox confines writes). Read it
