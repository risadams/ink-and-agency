...
codex-short-description: "Container escape and breakout techniques targeting Docker, containerd, and Podman…"
...
Journal: `~/.ink-and-agency/learnings/offensive-container-escape.md` (workspace-local
`.ink-and-agency/learnings/offensive-container-escape.md` where the sandbox confines writes). Read it
