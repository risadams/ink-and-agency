...
Journal: `~/.ink-and-agency/learnings/agent-installer.md` (workspace-local
`.ink-and-agency/learnings/agent-installer.md` where the sandbox confines writes). Read it
