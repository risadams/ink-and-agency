...
- **[grill-with-docs](../../research-analysis/grill-with-docs/)** / **[work-plan](../../meta-orchestration/work-plan/)** — the thinking steps that precede this write-up.
- **[plan-to-tickets](../../meta-orchestration/plan-to-tickets/)** — the next step: breaks this spec into a local numbered task list beside it.
- **[issue-feature-breakdown](../../business-product/issue-feature-breakdown/)** — the read-only counterpart when you want analysis of an *existing* Jira ticket rather than a fresh spec.
