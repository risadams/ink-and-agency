...
- **[plan-to-spec](../../meta-orchestration/plan-to-spec/)** — the usual source: a staged `spec.md` this skill slices into tasks beside it.
- **[work-plan](../../meta-orchestration/work-plan/)** — plans *decisions* for a foggy effort; this turns a *settled* plan into build tasks (the next step once the fog clears).
- **[implement](../../codebase-build/implement/)** — works the staged tasks one at a time through its tunable build pipeline.
- **[issue-estimate-sp](../../business-product/issue-estimate-sp/)** — estimate story points once tasks become Jira tickets.
