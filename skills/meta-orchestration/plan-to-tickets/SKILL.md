...
journal — `~/.ink-and-agency/learnings/plan-to-tickets.md` and/or the workspace-local
`.ink-and-agency/learnings/plan-to-tickets.md` — if present, and apply its guidance.
