...
- **Pair with writing skills.** Defuddled output is clean enough to feed directly into [writing-shape](../../writing/writing-shape/) or [writing-fragments](../../writing/writing-fragments/) as raw material for an article that synthesizes multiple sources.
...
- **[writing-shape](../../writing/writing-shape/)** — defuddled articles make excellent raw material; pipe the output as input.
- **[writing-fragments](../../writing/writing-fragments/)** — for mining ideas from a defuddled article into a fragment file before shaping.
