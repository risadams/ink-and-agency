...
Journal: `~/.ink-and-agency/learnings/it-ops-orchestrator.md` (workspace-local
`.ink-and-agency/learnings/it-ops-orchestrator.md` where the sandbox confines writes). Read it
