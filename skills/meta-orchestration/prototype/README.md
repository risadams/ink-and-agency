...
- **[implement](../../codebase-build/implement/)** — builds the real thing once the question is answered (its `prototype` preset is a *pipeline* setting, not this skill).
- **[tdd](../../codebase-build/tdd/)** — puts real behaviour tests around the validated logic module after it's lifted out.
- **[plan-to-spec](../plan-to-spec/)** — inlines decision-rich prototype snippets (state machine, schema, type shape) into a written spec.
- **[ui-designer](../../core-development/ui-designer/)** — design-system, hierarchy, and accessibility judgement on the winning variant.
