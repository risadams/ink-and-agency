...
- [handoff](../../meta-orchestration/handoff/)
- [multi-agent-coordinator](../../meta-orchestration/multi-agent-coordinator/)
- [knowledge-synthesizer](../../meta-orchestration/knowledge-synthesizer/)
...
Model-invoked from the `description` triggers above, or run by name (`context-manager`). Compatible with: claude-code codex opencode.
