...
- [ ] Self-Evolve footer present — run `pwsh ./scripts/add-self-evolve.ps1` after creating the skill (lint enforces it; see [SELF-EVOLVE.md](../../SELF-EVOLVE.md))
...
journal — `~/.ink-and-agency/learnings/skill-create.md` and/or the workspace-local
`.ink-and-agency/learnings/skill-create.md` — if present, and apply its guidance.
