...
A: Under 100 lines is the soft limit. Over 100 is a signal to split, not necessarily a problem. Some skills genuinely need more (e.g., a 200-line skill with 26 documented patterns is fine — see [writing-humanize](../../writing/writing-humanize/)).
