...
journal — `~/.ink-and-agency/learnings/break-it-down.md` and/or the workspace-local
`.ink-and-agency/learnings/break-it-down.md` — if present, and apply its guidance.
