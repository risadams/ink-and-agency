...
- **Obsidian vault** — write the note into the inbox folder via [obsidian-vault](../../obsidian/obsidian-vault/).
...
A: No — that's [obsidian-vault](../../obsidian/obsidian-vault/)'s job (and a future "review my hyperfixations" skill, not built yet). Interest-capture only writes.
...
- **[task-initiation](../../exec-function/task-initiation/)** — for when capture isn't the right answer because you actually want to act on the idea now.
- **[hyperfocus-recovery](../../exec-function/hyperfocus-recovery/)** — sibling for the reverse case: returning to a thread you already started.
- **[obsidian-vault](../../obsidian/obsidian-vault/)** — the underlying vault writer; interest-capture is a thin layer that fills in fixed-shape metadata.
- **[writing-fragments](../../writing/writing-fragments/)** — when the burst of ideas is specifically writing material rather than project ideas.
