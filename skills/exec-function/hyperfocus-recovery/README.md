...
- **[task-initiation](../../exec-function/task-initiation/)** — sibling for the case where you're not returning to anything, you just can't start. Same shape of one-action handoff.
- **[interest-capture](../../exec-function/interest-capture/)** — for stashing a new idea that surfaces during recovery so it doesn't pull you sideways.
- **[good-morning](../../scrum-sprint/good-morning/)** — calls hyperfocus-recovery as part of the morning routine.
