...
A: Because planning is what got you stuck. If you genuinely need a plan, use [codebase-plan-refactor](../../codebase-build/codebase-plan-refactor/) or [grill-me](../../research-analysis/grill-me/). Task-initiation is specifically for when planning is the trap.
...
- **[hyperfocus-recovery](../../exec-function/hyperfocus-recovery/)** — sibling for the inverse case: you *were* working and got pulled away and now don't know where to re-enter. Same shape of output (one literal action).
- **[codebase-plan-refactor](../../codebase-build/codebase-plan-refactor/)** — when you actually do need a plan.
- **[grill-me](../../research-analysis/grill-me/)** — when the stall is "I don't know what I'm doing" rather than "I can't start."
- **[interest-capture](../../exec-function/interest-capture/)** — when the stall is because a hyperfixation just lit up. Capture it, then return here.
