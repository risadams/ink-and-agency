...
- **[obsidian-vault](../../obsidian/obsidian-vault/)** — for searching across the daily/weekly/monthly notes the briefing produces.
- **[obsidian-bases](../../obsidian/obsidian-bases/)** — the briefing references base files (`Daily Notes Dashboard.base`, `Weekly Rollups.base`) that render embedded views in the daily note.
- **[obsidian-markdown](../../obsidian/obsidian-markdown/)** — for the Obsidian-flavored markdown syntax inside the templates.
