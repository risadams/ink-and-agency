...
journal — `~/.ink-and-agency/learnings/daily-briefing.md` and/or the workspace-local
`.ink-and-agency/learnings/daily-briefing.md` — if present, and apply its guidance.
