...
codex-short-description: "Wireless / 802.11 attack methodology for red team engagements and wireless security…"
...
Journal: `~/.ink-and-agency/learnings/offensive-wifi.md` (workspace-local
`.ink-and-agency/learnings/offensive-wifi.md` where the sandbox confines writes). Read it
