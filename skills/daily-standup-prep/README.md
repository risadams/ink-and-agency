...
- **[sprint-snapshot](../sprint-snapshot/)** and **[clarity-council](../clarity-council/)** — own the sprint pulse; never reimplemented inline.
...
- **[sprint-snapshot](../sprint-snapshot/)** — owns the Phase 4.5 daily snapshot and the `_snapshots.jsonl` trend schema; always delegated, never reimplemented.
- **[clarity-council](../clarity-council/)** — owns the Phase 4.5 pulse council (infographics-expert + statistics-expert + scrum-master).
- **[daily-briefing](../daily-briefing/)** — the personal (Outlook-driven) sibling; both run on the same morning and share the vault-root resolution pattern.
- **[good-morning](../good-morning/)** — the wrapper that runs this skill (with sprint pulse) as one phase of a three-skill morning chain.
- **[obsidian-markdown](../obsidian-markdown/)** / **[obsidian-vault](../obsidian-vault/)** / **[obsidian-bases](../obsidian-bases/)** — the canonical references for extending the template, verifying wikilinks in bulk, or building a standup dashboard.
