...
journal — `~/.ink-and-agency/learnings/data-engineer.md` and/or the workspace-local
`.ink-and-agency/learnings/data-engineer.md` — if present, and apply its guidance.
