...
codex-short-description: "Dense description covering Server-Side Template Injection across Jinja2, Twig,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-ssti.md` (workspace-local
`.ink-and-agency/learnings/offensive-ssti.md` where the sandbox confines writes). Read it
