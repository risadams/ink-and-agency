...
- **[obsidian-markdown](../../obsidian/obsidian-markdown/)** — for the underlying tables and frontmatter that charts read from.
- **[obsidian-vault](../../obsidian/obsidian-vault/)** — for finding notes that contain chartable data.
- **[obsidian-bases](../../obsidian/obsidian-bases/)** — for tabular views of data; complementary to charts (table for browsing, chart for trend).
- **[obsidian-cli](../../obsidian/obsidian-cli/)** — for bulk-inserting `^blockId`s or chart codeblocks across many notes.
