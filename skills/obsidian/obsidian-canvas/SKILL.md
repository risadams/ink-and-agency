...
journal — `~/.ink-and-agency/learnings/obsidian-canvas.md` and/or the workspace-local
`.ink-and-agency/learnings/obsidian-canvas.md` — if present, and apply its guidance.
