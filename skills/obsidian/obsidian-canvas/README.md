...
- ❌ **Modify the notes that file-type nodes reference.** The canvas points at notes; editing the notes is a separate skill ([obsidian-markdown](../../obsidian/obsidian-markdown/) or [obsidian-cli](../../obsidian/obsidian-cli/)).
...
A: Text nodes support full markdown, including Mermaid blocks. To link Mermaid nodes to vault notes, add `class NodeName internal-link;` inside the Mermaid block (see [obsidian-markdown](../../obsidian/obsidian-markdown/) for syntax details).
...
- **[obsidian-vault](../../obsidian/obsidian-vault/)** — for the underlying notes that file-type nodes reference.
- **[obsidian-markdown](../../obsidian/obsidian-markdown/)** — for the markdown content inside text nodes (callouts, embeds, wikilinks all work).
