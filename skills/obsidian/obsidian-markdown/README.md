...
- ❌ **Use literal `\n` in note content.** Markdown uses real newlines, not escapes. The escapes only matter for canvas text nodes (see [obsidian-canvas](../../obsidian/obsidian-canvas/)).
...
- **[obsidian-vault](../../obsidian/obsidian-vault/)** — for organizing notes once they're written (index notes, wikilink discipline, finding untagged references).
- **[obsidian-bases](../../obsidian/obsidian-bases/)** — frontmatter properties this skill writes are what bases query against.
- **[obsidian-canvas](../../obsidian/obsidian-canvas/)** — text nodes inside canvases use Obsidian markdown syntax (with `\n` escaping for JSON).
- **[obsidian-cli](../../obsidian/obsidian-cli/)** — for shell-driven creation/editing when scripting.
