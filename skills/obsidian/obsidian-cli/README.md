...
- **[obsidian-vault](../../obsidian/obsidian-vault/)** — for shell-side vault operations using `find` and `grep` directly (no Obsidian process required).
- **[obsidian-markdown](../../obsidian/obsidian-markdown/)** — for the markdown syntax of notes that the CLI creates and modifies.
- **[obsidian-bases](../../obsidian/obsidian-bases/)** — when bulk-modifying property values, generate the CLI command pattern from a base view's results.
