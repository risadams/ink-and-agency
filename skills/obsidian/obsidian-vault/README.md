...
- ❌ **Modify notes through Obsidian's API.** The skill operates on the filesystem directly. For app-aware operations (daily-note appending, property setting), use [obsidian-cli](../../obsidian/obsidian-cli/).
...
The low-count tags at the bottom are usually typos of high-count ones. Fix manually with grep + sed, or via [obsidian-cli](../../obsidian/obsidian-cli/).
...
- **[obsidian-markdown](../../obsidian/obsidian-markdown/)** — for the syntax inside the notes this skill creates and searches.
- **[obsidian-cli](../../obsidian/obsidian-cli/)** — for app-aware operations (daily notes, properties, plugin reloading) when Obsidian is running.
- **[obsidian-bases](../../obsidian/obsidian-bases/)** — for query-driven views (table/card/list) over the notes managed here.
- **[obsidian-canvas](../../obsidian/obsidian-canvas/)** — for visual layouts of notes and links.
