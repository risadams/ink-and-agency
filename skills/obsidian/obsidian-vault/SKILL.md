...
Journal: `~/.ink-and-agency/learnings/obsidian-vault.md` (workspace-local
`.ink-and-agency/learnings/obsidian-vault.md` where the sandbox confines writes). Read it
