...
journal — `~/.ink-and-agency/learnings/obsidian-vault.md` and/or the workspace-local
`.ink-and-agency/learnings/obsidian-vault.md` — if present, and apply its guidance.
