...
codex-short-description: "Practical offensive fuzzing methodology covering target identification, fuzzer…"
...
Journal: `~/.ink-and-agency/learnings/offensive-fuzzing.md` (workspace-local
`.ink-and-agency/learnings/offensive-fuzzing.md` where the sandbox confines writes). Read it
