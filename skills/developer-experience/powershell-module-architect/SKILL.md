...
Journal: `~/.ink-and-agency/learnings/powershell-module-architect.md` (workspace-local
`.ink-and-agency/learnings/powershell-module-architect.md` where the sandbox confines writes). Read it
