...
Journal: `~/.ink-and-agency/learnings/powershell-ui-architect.md` (workspace-local
`.ink-and-agency/learnings/powershell-ui-architect.md` where the sandbox confines writes). Read it
