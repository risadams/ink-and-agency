...
- **[codebase-plan-refactor](../../codebase-build/codebase-plan-refactor/)** — for refactor work, plan the small commits first; the rebase skill keeps them clean against main as you go.
