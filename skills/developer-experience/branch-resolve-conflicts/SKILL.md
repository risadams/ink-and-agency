...
journal — `~/.ink-and-agency/learnings/branch-resolve-conflicts.md` and/or the workspace-local
`.ink-and-agency/learnings/branch-resolve-conflicts.md` — if present, and apply its guidance.
