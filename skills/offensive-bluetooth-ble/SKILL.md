...
Journal: `~/.ink-and-agency/learnings/offensive-bluetooth-ble.md` (workspace-local
`.ink-and-agency/learnings/offensive-bluetooth-ble.md` where the sandbox confines writes). Read it
