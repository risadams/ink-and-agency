...
Journal: `~/.ink-and-agency/learnings/offensive-graphql.md` (workspace-local
`.ink-and-agency/learnings/offensive-graphql.md` where the sandbox confines writes). Read it
