...
codex-short-description: "WPS (Wi-Fi Protected Setup) PIN attack methodology — Pixie Dust offline attack against…"
...
Journal: `~/.ink-and-agency/learnings/offensive-wps.md` (workspace-local
`.ink-and-agency/learnings/offensive-wps.md` where the sandbox confines writes). Read it
