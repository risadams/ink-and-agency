...
Journal: `~/.ink-and-agency/learnings/offensive-shellcode.md` (workspace-local
`.ink-and-agency/learnings/offensive-shellcode.md` where the sandbox confines writes). Read it
