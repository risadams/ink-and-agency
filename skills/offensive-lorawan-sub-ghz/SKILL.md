...
Journal: `~/.ink-and-agency/learnings/offensive-lorawan-sub-ghz.md` (workspace-local
`.ink-and-agency/learnings/offensive-lorawan-sub-ghz.md` where the sandbox confines writes). Read it
