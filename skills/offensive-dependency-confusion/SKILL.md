...
codex-short-description: "Deep-dive offensive methodology for dependency confusion and namespace attacks across…"
...
Journal: `~/.ink-and-agency/learnings/offensive-dependency-confusion.md` (workspace-local
`.ink-and-agency/learnings/offensive-dependency-confusion.md` where the sandbox confines writes). Read it
