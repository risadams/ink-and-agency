...
Journal: `~/.ink-and-agency/learnings/offensive-business-logic.md` (workspace-local
`.ink-and-agency/learnings/offensive-business-logic.md` where the sandbox confines writes). Read it
