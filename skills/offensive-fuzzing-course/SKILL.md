...
Journal: `~/.ink-and-agency/learnings/offensive-fuzzing-course.md` (workspace-local
`.ink-and-agency/learnings/offensive-fuzzing-course.md` where the sandbox confines writes). Read it
