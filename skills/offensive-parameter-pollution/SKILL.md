...
codex-short-description: "HTTP parameter pollution (HPP) checklist: duplicate parameter injection, backend vs…"
...
Journal: `~/.ink-and-agency/learnings/offensive-parameter-pollution.md` (workspace-local
`.ink-and-agency/learnings/offensive-parameter-pollution.md` where the sandbox confines writes). Read it
