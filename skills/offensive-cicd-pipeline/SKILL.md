...
Journal: `~/.ink-and-agency/learnings/offensive-cicd-pipeline.md` (workspace-local
`.ink-and-agency/learnings/offensive-cicd-pipeline.md` where the sandbox confines writes). Read it
