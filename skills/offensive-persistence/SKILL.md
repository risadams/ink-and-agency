...
Journal: `~/.ink-and-agency/learnings/offensive-persistence.md` (workspace-local
`.ink-and-agency/learnings/offensive-persistence.md` where the sandbox confines writes). Read it
