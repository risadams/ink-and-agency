...
description: "Comprehensive methodology for auditing and exploiting TLS/SSL implementations and misconfigurations across network services and mobile applications. Covers protocol downgrade attacks including POODLE (CVE-2014-3566) against SSLv3 CBC padding, DROWN (CVE-2016-0800) cross-protocol attack leveraging SSLv2 export ciphers to decrypt TLS sessions, and FREAK (CVE-2015-0204) forcing RSA export-grade key exchange. Addresses BEAST (CVE-2011-3389) exploiting CBC IV predictability in TLS 1.0, CRIME (CVE-2012-4929) and BREACH targeting TLS-level and HTTP-level compression oracles respectively, and Heartbleed (CVE-2014-0160) for OpenSSL memory disclosure. . Use when performing authorized red-team, pentest, or research work involving tls attacks."
codex-short-description: "Comprehensive methodology for auditing and exploiting TLS/SSL implementations and…"
...
Journal: `~/.ink-and-agency/learnings/offensive-tls-attacks.md` (workspace-local
`.ink-and-agency/learnings/offensive-tls-attacks.md` where the sandbox confines writes). Read it
