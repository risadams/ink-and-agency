...
codex-short-description: "Zigbee, Thread, and Matter mesh-protocol attack methodology — IEEE 802.15.4 sniffing…"
...
Journal: `~/.ink-and-agency/learnings/offensive-zigbee-thread-matter.md` (workspace-local
`.ink-and-agency/learnings/offensive-zigbee-thread-matter.md` where the sandbox confines writes). Read it
