...
Journal: `~/.ink-and-agency/learnings/powershell-5.1-expert.md` (workspace-local
`.ink-and-agency/learnings/powershell-5.1-expert.md` where the sandbox confines writes). Read it
