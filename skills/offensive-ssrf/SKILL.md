...
codex-short-description: "Server-Side Request Forgery testing checklist: SSRF discovery, blind SSRF with…"
...
Journal: `~/.ink-and-agency/learnings/offensive-ssrf.md` (workspace-local
`.ink-and-agency/learnings/offensive-ssrf.md` where the sandbox confines writes). Read it
