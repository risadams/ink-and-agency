...
Journal: `~/.ink-and-agency/learnings/offensive-sqli.md` (workspace-local
`.ink-and-agency/learnings/offensive-sqli.md` where the sandbox confines writes). Read it
