...
Journal: `~/.ink-and-agency/learnings/offensive-reporting.md` (workspace-local
`.ink-and-agency/learnings/offensive-reporting.md` where the sandbox confines writes). Read it
