...
Journal: `~/.ink-and-agency/learnings/offensive-windows-privesc.md` (workspace-local
`.ink-and-agency/learnings/offensive-windows-privesc.md` where the sandbox confines writes). Read it
