...
Journal: `~/.ink-and-agency/learnings/offensive-cicd-secrets.md` (workspace-local
`.ink-and-agency/learnings/offensive-cicd-secrets.md` where the sandbox confines writes). Read it
