...
Journal: `~/.ink-and-agency/learnings/offensive-mobile.md` (workspace-local
`.ink-and-agency/learnings/offensive-mobile.md` where the sandbox confines writes). Read it
