...
- **[issue-suggest-component](../../business-product/issue-suggest-component/)** — pair these on a backlog-grooming day. Run the dupe finder first, then suggest components on whatever survives.
- **[issue-triage](../../business-product/issue-triage/)** — when the scan flags a likely dupe but you're unsure which is the canonical ticket, triage both. The signal-gathering will surface the deeper context.
