...
- ❌ **Estimate epics or features.** The skill targets atomic work items (Story, Task, Bug). For features, use [issue-feature-breakdown](../../business-product/issue-feature-breakdown/) first to decompose, then estimate each piece.
