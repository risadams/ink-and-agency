...
journal — `~/.ink-and-agency/learnings/issue-estimate-sp.md` and/or the workspace-local
`.ink-and-agency/learnings/issue-estimate-sp.md` — if present, and apply its guidance.
