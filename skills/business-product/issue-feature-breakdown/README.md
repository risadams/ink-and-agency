...
- **Use it before estimating.** Pair with [issue-estimate-sp](../../business-product/issue-estimate-sp/): break down first, then estimate each piece. Estimating an undecomposed feature is how 21-point tickets are born.
...
- ❌ **Use it on bug tickets.** This skill assumes a feature with scope to decompose. For bugs, use [issue-triage](../../business-product/issue-triage/) instead — it ranks root causes rather than producing a breakdown.
