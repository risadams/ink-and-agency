...
journal — `~/.ink-and-agency/learnings/assumption-mapping.md` and/or the workspace-local
`.ink-and-agency/learnings/assumption-mapping.md` — if present, and apply its guidance.
