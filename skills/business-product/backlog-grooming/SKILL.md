...
journal — `~/.ink-and-agency/learnings/backlog-grooming.md` and/or the workspace-local
`.ink-and-agency/learnings/backlog-grooming.md` — if present, and apply its guidance.
