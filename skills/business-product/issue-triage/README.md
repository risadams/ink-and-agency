...
- ❌ **Triage tickets in bulk.** Use one ticket per invocation. The signal-gathering is too heavy to do well across many tickets in one pass; for sweep work, see [issue-dup-find](../../business-product/issue-dup-find/) instead.
