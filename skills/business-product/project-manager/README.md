...
- [sprint-plan](../../scrum-sprint/sprint-plan/)
- [daily-briefing](../../exec-function/daily-briefing/)
- [time-reality-check](../../exec-function/time-reality-check/)
- [task-initiation](../../exec-function/task-initiation/)
- [energy-budget](../../exec-function/energy-budget/)
...
Model-invoked from the `description` triggers above, or run by name (`project-manager`). Compatible with: claude-code codex opencode.
