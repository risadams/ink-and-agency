...
codex-short-description: "Dense methodology covering DNS exfiltration (dnscat2, iodine, dns2tcp), HTTPS…"
...
Journal: `~/.ink-and-agency/learnings/offensive-data-exfiltration.md` (workspace-local
`.ink-and-agency/learnings/offensive-data-exfiltration.md` where the sandbox confines writes). Read it
