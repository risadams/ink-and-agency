---
name: offensive-idor
description: "IDOR (Insecure Direct Object Reference) testing checklist: object ID enumeration, horizontal/vertical privilege escalation, GUID predictability, indirect references via hashes, chained IDOR, and API endpoint IDOR. Use for web app pentests and bug bounty IDOR discovery. Use when performing authorized red-team, pentest, or research work involving idor."
codex-short-description: "IDOR (Insecure Direct Object Reference) testing checklist: object ID enumeration,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-idor.md` (workspace-local
`.ink-and-agency/learnings/offensive-idor.md` where the sandbox confines writes). Read it
