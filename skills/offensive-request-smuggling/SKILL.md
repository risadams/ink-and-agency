...
codex-short-description: "HTTP request smuggling checklist: CL.TE, TE.CL, TE.TE variants, detection with timing…"
...
Journal: `~/.ink-and-agency/learnings/offensive-request-smuggling.md` (workspace-local
`.ink-and-agency/learnings/offensive-request-smuggling.md` where the sandbox confines writes). Read it
