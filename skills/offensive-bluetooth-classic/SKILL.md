...
codex-short-description: "Bluetooth Classic (BR/EDR) attack methodology — device discovery, service enumeration…"
...
Journal: `~/.ink-and-agency/learnings/offensive-bluetooth-classic.md` (workspace-local
`.ink-and-agency/learnings/offensive-bluetooth-classic.md` where the sandbox confines writes). Read it
