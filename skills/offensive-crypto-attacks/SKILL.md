...
codex-short-description: "Systematic methodology for identifying and exploiting cryptographic implementation…"
...
Journal: `~/.ink-and-agency/learnings/offensive-crypto-attacks.md` (workspace-local
`.ink-and-agency/learnings/offensive-crypto-attacks.md` where the sandbox confines writes). Read it
