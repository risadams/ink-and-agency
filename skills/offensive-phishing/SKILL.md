...
Journal: `~/.ink-and-agency/learnings/offensive-phishing.md` (workspace-local
`.ink-and-agency/learnings/offensive-phishing.md` where the sandbox confines writes). Read it
