...
Journal: `~/.ink-and-agency/learnings/offensive-wifi-recon.md` (workspace-local
`.ink-and-agency/learnings/offensive-wifi-recon.md` where the sandbox confines writes). Read it
