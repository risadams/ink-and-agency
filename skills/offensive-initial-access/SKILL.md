...
codex-short-description: "Initial access techniques checklist: phishing (spear/smishing), credential stuffing,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-initial-access.md` (workspace-local
`.ink-and-agency/learnings/offensive-initial-access.md` where the sandbox confines writes). Read it
