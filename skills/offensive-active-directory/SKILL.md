...
Journal: `~/.ink-and-agency/learnings/offensive-active-directory.md` (workspace-local
`.ink-and-agency/learnings/offensive-active-directory.md` where the sandbox confines writes). Read it
