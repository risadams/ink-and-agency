...
codex-short-description: "Kubernetes cluster attack techniques covering the full attack lifecycle from initial…"
...
Journal: `~/.ink-and-agency/learnings/offensive-k8s-attacks.md` (workspace-local
`.ink-and-agency/learnings/offensive-k8s-attacks.md` where the sandbox confines writes). Read it
