...
- **[research](../research/)** — delegate deeper source-gathering to a background agent when a topic needs more vetted resources than a lesson pass turns up.
- **[grill-me](../grill-me/)** — the questioning discipline the mission-elicitation step mirrors; useful for pinning down a fuzzy learning goal.
- **[obsidian-vault](../obsidian-vault/)** — if the user prefers their learning notes and records living in an Obsidian vault rather than a bare workspace directory.
