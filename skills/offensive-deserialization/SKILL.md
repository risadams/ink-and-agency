...
Journal: `~/.ink-and-agency/learnings/offensive-deserialization.md` (workspace-local
`.ink-and-agency/learnings/offensive-deserialization.md` where the sandbox confines writes). Read it
