...
codex-short-description: "Security mitigation reference and bypass catalog: ASLR, DEP/NX, RELRO, stack canaries,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-mitigations.md` (workspace-local
`.ink-and-agency/learnings/offensive-mitigations.md` where the sandbox confines writes). Read it
