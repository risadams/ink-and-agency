...
Deliberate pros/cons analysis with weighted scoring and a recommendation. Designed for ideas the user is already considering — not for generating new ones (use [idea-generate](../../research-analysis/idea-generate/)) and not for "just pick one already" (use [idea-decision-maker](../../research-analysis/idea-decision-maker/)).
