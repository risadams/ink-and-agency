...
journal — `~/.ink-and-agency/learnings/idea-generate.md` and/or the workspace-local
`.ink-and-agency/learnings/idea-generate.md` — if present, and apply its guidance.
