...
- **Treat the grill as a forge, not a court.** [grill-me](../../research-analysis/grill-me/) finds weaknesses so you can fix them — not to kill the idea. Push back on any question that feels like it's just trying to discourage you.
...
- ❌ **Use this for problems that have a known answer.** "How do I fix this bug" is not an idea-generation task. Use [issue-triage](../../business-product/issue-triage/) or [grill-me](../../research-analysis/grill-me/) directly.
...
A: It works, but for binary decisions try [idea-decision-maker](../../research-analysis/idea-decision-maker/) first — it's purpose-built for "pick A or B" stalls.
...
- **[writing-fragments](../../writing/writing-fragments/)** — when the raw material is for an article, not a project.
