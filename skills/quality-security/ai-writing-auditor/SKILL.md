...
journal — `~/.ink-and-agency/learnings/ai-writing-auditor.md` and/or the workspace-local
`.ink-and-agency/learnings/ai-writing-auditor.md` — if present, and apply its guidance.
