...
description: >
  Use when the user needs to understand GDPR or CCPA compliance, review data practices, or
  assess privacy requirements. Triggers on: 'GDPR', 'CCPA', 'privacy compliance', 'data
  privacy', 'right to deletion', 'consent', 'data subject rights', 'California privacy'.
...
Journal: `~/.ink-and-agency/learnings/gdpr-ccpa-compliance.md` (workspace-local
`.ink-and-agency/learnings/gdpr-ccpa-compliance.md` where the sandbox confines writes). Read it
