...
journal — `~/.ink-and-agency/learnings/gdpr-ccpa-compliance.md` and/or the workspace-local
`.ink-and-agency/learnings/gdpr-ccpa-compliance.md` — if present, and apply its guidance.
