...
- [error-detective](../../quality-security/error-detective/)
...
Model-invoked from the `description` triggers above, or run by name (`debugger`). Compatible with: claude-code codex opencode.
