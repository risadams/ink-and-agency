...
journal — `~/.ink-and-agency/learnings/powershell-security-hardening.md` and/or the workspace-local
`.ink-and-agency/learnings/powershell-security-hardening.md` — if present, and apply its guidance.
