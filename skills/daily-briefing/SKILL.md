...
Journal: `~/.ink-and-agency/learnings/daily-briefing.md` (workspace-local
`.ink-and-agency/learnings/daily-briefing.md` where the sandbox confines writes). Read it
