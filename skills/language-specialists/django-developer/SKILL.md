...
journal — `~/.ink-and-agency/learnings/django-developer.md` and/or the workspace-local
`.ink-and-agency/learnings/django-developer.md` — if present, and apply its guidance.
