...
Journal: `~/.ink-and-agency/learnings/powershell-7-expert.md` (workspace-local
`.ink-and-agency/learnings/powershell-7-expert.md` where the sandbox confines writes). Read it
