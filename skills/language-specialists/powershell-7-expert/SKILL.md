...
journal — `~/.ink-and-agency/learnings/powershell-7-expert.md` and/or the workspace-local
`.ink-and-agency/learnings/powershell-7-expert.md` — if present, and apply its guidance.
