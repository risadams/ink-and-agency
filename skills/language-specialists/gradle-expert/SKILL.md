...
journal — `~/.ink-and-agency/learnings/gradle-expert.md` and/or the workspace-local
`.ink-and-agency/learnings/gradle-expert.md` — if present, and apply its guidance.
