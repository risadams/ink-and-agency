...
codex-short-description: "WPA3 / SAE (Simultaneous Authentication of Equals) attack methodology —…"
...
Journal: `~/.ink-and-agency/learnings/offensive-wpa3-sae.md` (workspace-local
`.ink-and-agency/learnings/offensive-wpa3-sae.md` where the sandbox confines writes). Read it
