...
codex-short-description: "KRACK (CVE-2017-13077..082) and FragAttacks (CVE-2020-24586..588 + 26139-26147) — key…"
...
Journal: `~/.ink-and-agency/learnings/offensive-krack-fragattacks.md` (workspace-local
`.ink-and-agency/learnings/offensive-krack-fragattacks.md` where the sandbox confines writes). Read it
