...
codex-short-description: "Exploit development curriculum covering core vulnerability classes with real-world CVE…"
...
Journal: `~/.ink-and-agency/learnings/offensive-vuln-classes.md` (workspace-local
`.ink-and-agency/learnings/offensive-vuln-classes.md` where the sandbox confines writes). Read it
