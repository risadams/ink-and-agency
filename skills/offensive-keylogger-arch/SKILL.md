...
codex-short-description: "Low-level keylogger architecture design: kernel driver hooks (WH_KEYBOARD_LL,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-keylogger-arch.md` (workspace-local
`.ink-and-agency/learnings/offensive-keylogger-arch.md` where the sandbox confines writes). Read it
