...
Identical to `daily-standup-prep`. Use the cascade in [../daily-standup-prep/REFERENCE.md](../../scrum-sprint/daily-standup-prep/REFERENCE.md#identity-matching-cascade) verbatim. Inputs available to the matcher per Jira issue:
...
5. No node text contains a literal `\\n` (must be `\n` — see [obsidian-canvas/SKILL.md](../../obsidian/obsidian-canvas/SKILL.md) "Newline pitfall").
