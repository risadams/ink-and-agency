...
- **[sprint-plan](../../scrum-sprint/sprint-plan/)** — start-of-sprint planning report; consumes `start.canvas` and the previous sprint's `end.canvas`
- **[sprint-sos-report](../../scrum-sprint/sprint-sos-report/)** — weekly scrum-of-scrums report; compares any two snapshots
- **[sprint-review](../../scrum-sprint/sprint-review/)** — end-of-sprint stakeholder report; compares `start.canvas` to `end.canvas`
- **[obsidian-canvas](../../obsidian/obsidian-canvas/)** — Phase 5 delegates to it for canvas authoring
