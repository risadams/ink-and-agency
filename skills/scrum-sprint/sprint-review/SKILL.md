...
This skill is the Claude port of the user's "Sprint Review" prompt template. Pairs with [sprint-plan](../../scrum-sprint/sprint-plan/SKILL.md) (start-of-sprint) and [sprint-sos-report](../../scrum-sprint/sprint-sos-report/SKILL.md) (weekly).
