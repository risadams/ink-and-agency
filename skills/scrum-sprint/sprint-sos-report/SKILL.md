...
This skill is the Claude port of the user's "Scrum of Scrums" prompt template. It expects [sprint-snapshot](../../scrum-sprint/sprint-snapshot/SKILL.md) has produced at least two snapshots in the target sprint folder. Pairs naturally with [sprint-plan](../../scrum-sprint/sprint-plan/SKILL.md) (start-of-sprint) and [sprint-review](../../scrum-sprint/sprint-review/SKILL.md) (end-of-sprint).
...
Same resolution as `sprint-plan` Phase 1. `_team-rules.md` is **load-bearing here** — wedge balancing, in-review overhead exclusion, and overhead-adjusted velocity all depend on it. Bootstrap if missing (per [sprint-snapshot/REFERENCE.md](../../scrum-sprint/sprint-snapshot/REFERENCE.md#bootstrap)).
