...
codex-short-description: "Cross-Site Scripting testing checklist: stored/reflected/DOM/blind XSS discovery,…"
...
Journal: `~/.ink-and-agency/learnings/offensive-xss.md` (workspace-local
`.ink-and-agency/learnings/offensive-xss.md` where the sandbox confines writes). Read it
