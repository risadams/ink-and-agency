...
codex-short-description: "Windows security boundary taxonomy and attack surface enumeration: kernel/user…"
...
Journal: `~/.ink-and-agency/learnings/offensive-windows-boundaries.md` (workspace-local
`.ink-and-agency/learnings/offensive-windows-boundaries.md` where the sandbox confines writes). Read it
