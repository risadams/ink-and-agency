...
Journal: `~/.ink-and-agency/learnings/offensive-social-engineering.md` (workspace-local
`.ink-and-agency/learnings/offensive-social-engineering.md` where the sandbox confines writes). Read it
