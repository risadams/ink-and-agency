...
codex-short-description: "Comprehensive OSINT methodology skill for offensive security, red team intelligence…"
...
Journal: `~/.ink-and-agency/learnings/offensive-osint.md` (workspace-local
`.ink-and-agency/learnings/offensive-osint.md` where the sandbox confines writes). Read it
