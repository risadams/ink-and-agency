...
codex-short-description: "File upload vulnerability checklist: MIME type bypass, extension bypass, magic byte…"
...
Journal: `~/.ink-and-agency/learnings/offensive-file-upload.md` (workspace-local
`.ink-and-agency/learnings/offensive-file-upload.md` where the sandbox confines writes). Read it
