...
Journal: `~/.ink-and-agency/learnings/offensive-rce.md` (workspace-local
`.ink-and-agency/learnings/offensive-rce.md` where the sandbox confines writes). Read it
