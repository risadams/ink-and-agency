...
codex-short-description: "WAF bypass techniques checklist: encoding bypass (URL/HTML/Unicode/double encoding),…"
...
Journal: `~/.ink-and-agency/learnings/offensive-waf-bypass.md` (workspace-local
`.ink-and-agency/learnings/offensive-waf-bypass.md` where the sandbox confines writes). Read it
